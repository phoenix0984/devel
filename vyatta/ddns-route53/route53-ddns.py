...
def send_mail(smtp_server, smtp_port, from_addr, from_pass, to_addr, cc_addr, msg_subj, msg_body):
    ...
    s.sendmail(from_addr, to_addr.split(", ") + cc_addr.split(", "), message.as_string())
    s.quit()
...
if __name__ == '__main__':
    ...
    # Do the hard work
    upsert_rrset()
    send_mail(smtp_server, smtp_port, from_addr, from_pass, to_addr, cc_addr, msg_subj, msg_body)
else:
    sys.exit(0)